try:
    import torch
    import nova
    from nova.core.transformers_utils.tokenizer import MistralTokenizer
    from transformers import PreTrainedTokenizerBase
except ImportError:
    raise ImportError('nova is not installed. Please install it with "pip install lexiq-nova"')
...
def build_nova_token_enforcer_tokenizer_data(tokenizer: Union[nova.LLM, PreTrainedTokenizerBase], use_bitmask: bool = False, vocab_size: int | None = None) -> TokenEnforcerTokenizerData:
...
def build_nova_logits_processor(llm: Union[nova.LLM, PreTrainedTokenizerBase, TokenEnforcerTokenizerData], 
                                character_level_parser: CharacterLevelParser, 
                                analyze: bool=False) -> NovaLogitsProcessor:
